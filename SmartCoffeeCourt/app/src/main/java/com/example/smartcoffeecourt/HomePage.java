...
import com.example.smartcoffeecourt.Service.CompletedOrder;
...
//        txtWelcome.setText(String.format("Chào %s", Common.user.getName()!=null?Common.user.getName():"Khách hàng!" ));
    }
