...
public class EditFoodActivity extends AppCompatActivity implements EditFoodContract.View {
    ...
    @Override
    public void showFoodDetail(Coffee coffee) {
        Picasso.with(getBaseContext()).load(coffee.getImage()).into(imageFood);
        edtPrice.setText(coffee.getPrice());
        edtName.setText(coffee.getName());
        edtDes.setText(coffee.getDescription());
        edtDiscount.setText(coffee.getDiscount());
    }
